...
const FacultyProfile = (user_details) => {
  ...
  useEffect(() => {
    setUserData({
      ...
      accountVerification: localStorage.getItem("v_by_a"),
    });
  }, []);
      ...
      <div className="w-[25%] bg-gray-100 p-6 overflow-y-auto border-r">
        <div className="flex flex-col">
          ...
          <div className="text-sm space-y-3">
            ...
            {(userData?.role === "true" && userData?.accountVerification === "false") &&<p className="text-red-500">Account Verification Required</p>}
          </div>
        </div>
      </div>
